...
function ui.init(parent)
	...
	-- Create Image_32
	local Image_32 = GUI:Image_Create(Panel_2, "Image_32", 143.00, 15.00, "res/private/trading_bank/bg_yyxsz_02.png")
	...
	-- Create Image_32_0
	local Image_32_0 = GUI:Image_Create(Panel_2, "Image_32_0", 276.00, 15.00, "res/private/trading_bank/bg_yyxsz_02.png")
	...
	-- Create Image_32_0_0
	local Image_32_0_0 = GUI:Image_Create(Panel_2, "Image_32_0_0", 367.00, 15.00, "res/private/trading_bank/bg_yyxsz_02.png")
	...
	local Image_32_0_0_0 = GUI:Image_Create(Panel_2, "Image_32_0_0_0", 474.00, 15.00, "res/private/trading_bank/bg_yyxsz_02.png")
	...
	-- Create Panel_type2
	local Panel_type2 = GUI:Layout_Create(Panel_2, "Panel_type2", 0.00, 30.00, 143.00, 30.00, false)
	...
	-- Create Text_3_0
	local Text_3_0 = GUI:Text_Create(Panel_2, "Text_3_0", 212.00, 14.00, 18, "#ffffff", [[寄售人]])
	...
	-- Create Panel_num2
	local Panel_num2 = GUI:Layout_Create(Panel_2, "Panel_num2", 322.00, 0.00, 89.00, 30.00, false)
	...
	-- Create Panel_price2
	local Panel_price2 = GUI:Layout_Create(Panel_2, "Panel_price2", 368.00, 1.00, 104.00, 30.00, false)
	GUI:setTouchEnabled(Panel_price2, true)
	GUI:setTag(Panel_price2, 180)

	-- Create Text_3_1
	local Text_3_1 = GUI:Text_Create(Panel_price2, "Text_3_1", 52.00, 13.00, 18, "#ffffff", [[价格]])
	...
	-- Create Image_8
	local Image_8 = GUI:Image_Create(Panel_price2, "Image_8", 81.00, 12.00, "res/private/trading_bank/word_jiaoyh_016.png")
	GUI:setAnchorPoint(Image_8, 0.50, 0.50)
	GUI:setTouchEnabled(Image_8, false)
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_item, "Text_name", 209.00, 44.00, 16, "#ffffff", [[名字七个字啊啊]])
	...
	-- Create Text_num
	local Text_num = GUI:Text_Create(Panel_item, "Text_num", 324.00, 42.00, 16, "#ffffff", [[99]])
	...
	-- Create Text_pirce
	local Text_pirce = GUI:Text_Create(Panel_item, "Text_pirce", 416.00, 41.00, 16, "#ffffff", [[9999]])
